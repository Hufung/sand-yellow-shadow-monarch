export type PaperId = 1 | 2 | 3 | 4 | 5;

export type AcceptedMark =
  | { type: "replace"; word: string; to: string; nth?: number }
  | { type: "insert"; word: string; after?: string; before?: string; nth?: number }
  | { type: "delete"; word: string; nth?: number }
  | { type: "none" };
...
export const papers: { id: PaperId; title: string; subtitle: string }[] = [
  { id: 1, title: "Paper I", subtitle: "A–C · according to – come back" },
  { id: 2, title: "Paper II", subtitle: "C–E · comfort – everyone" },
  { id: 3, title: "Paper III", subtitle: "F–L · famous – lack" },
  { id: 4, title: "Paper IV", subtitle: "L–R · lead – result" },
  { id: 5, title: "Paper V", subtitle: "R–Z · rise – your" },
];
...
export const questions: Question[] = [
  {
    ...
    paper: 1,
    prompt:
      "I am afraid of acrossing that road at night, but I cannot avoid doing so; otherwise, I can't go back home.",
    accepted: [{ type: "replace", word: "acrossing", to: "crossing" }],
  ...
  },
  {
    ...
    paper: 1,
    prompt:
      "Although the price of this umbrella is low, I still choose that umbrella because I like red color.",
    accepted: [
      { type: "delete", word: "color" },
      { type: "delete", word: "colour" },
      { type: "replace", word: "color", to: "colour" },
    ],
    explanation:
      "Do not add 'colour/color' after a colour word. Say 'I like red'. (If you only Americanised the spelling, that is not the error the paper is after.)",
    headword: "colour",
  },
  {
    id: "p1-03",
    ...
    accepted: [
      { type: "delete", word: "too" },
      { type: "delete", word: "also" },
    ],
  ...
  },
  {
    ...
    paper: 1,
    prompt:
      "Scientists are conducting a chemical analysis to analyse a blue substance found on Mars.",
    accepted: [{ type: "none" }],
    explanation:
      "No grammar error. 'Analysis' is the noun and 'analyse' is the verb, and both are used correctly.",
    headword: "analysis",
  },
  {
    id: "p1-05",
    paper: 1,
    prompt:
      "The father arrived at the hospital at 3:00 p.m. and he waited there anxiously for 5 hours; at last, his baby born at 8:15 p.m.",
    accepted: [{ type: "insert", word: "was", before: "born" }],
  ...
  },
  {
    ...
    paper: 1,
    prompt:
      "Mother called him to choose the cheap shoes, but he refused. He went back home with the most expensive choice – a pair of Naike costing $1,200!",
    accepted: [
      { type: "replace", word: "called", to: "told" },
      { type: "replace", word: "called", to: "asked" },
    ],
    explanation:
      "'Call' is not used for giving an instruction. Use 'told' or 'asked' him to choose.",
    headword: "call",
  },
  {
    id: "p1-07",
    paper: 1,
    prompt:
      "She feels happy when she arrives school. However, she feels depressed when she arrives home because of her poor relationship with her parents.",
    accepted: [{ type: "insert", word: "at", after: "arrives", nth: 0 }],
    explanation:
      "Arrive at a building (school). 'Home' is one of the few places that takes no preposition.",
    headword: "arrive",
  },
  {
    id: "p2-01",
    paper: 2,
    prompt:
      "This social worker concerned about the poor boy whose father died in a traffic accident last night.",
    accepted: [
      { type: "insert", word: "is", before: "concerned" },
      { type: "insert", word: "was", before: "concerned" },
    ],
    explanation:
      "People 'are concerned about' something. The verb 'concern' does not take 'about'.",
    headword: "concern",
  },
  {
    id: "p2-02",
    ...
    accepted: [{ type: "replace", word: "complicate", to: "complicated" }],
  ...
  },
  {
    ...
    paper: 2,
    prompt:
      "In this details report, the scientist emphasizes the importance of stopping global warming.",
    accepted: [
      { type: "replace", word: "details", to: "detailed" },
      { type: "replace", word: "emphasizes", to: "emphasises" },
    ],
  ...
  },
  {
    ...
    paper: 2,
    prompt:
      "Despite the comfort that the hotel offers, he still complained about the poor attitude of the staff there.",
    accepted: [{ type: "none" }],
    explanation:
      "No error. 'Comfort' is correctly used as a noun, and 'complained about' is the right verb pattern.",
    headword: "comfort",
  },
  {
    id: "p2-05",
    ...
    accepted: [{ type: "none" }],
    explanation:
      "No error. 'Everyone' takes a singular verb, and both 'convenient' and 'dull' are adjectives describing the journey.",
    headword: "everybody",
  },
  {
    id: "p2-06",
    paper: 2,
    prompt:
      "The company spent a lot of money buying equipments. They bought printers, computers, and etc.",
    accepted: [
      { type: "replace", word: "equipments", to: "equipment" },
      { type: "delete", word: "and" },
    ],
    explanation:
      "Two classic traps appear here, but you only need to catch one: 'equipment' is uncountable, and 'etc.' already contains 'and'.",
    headword: "equipment",
  },
  {
    id: "p2-07",
    ...
    accepted: [{ type: "delete", word: "about" }],
  ...
  },
  {
    ...
    accepted: [{ type: "none" }],
    explanation:
      "No error. Bags inside a hall go on the floor. 'Ground' is the outdoor surface.",
    headword: "floor",
  },
  {
    id: "p3-02",
    ...
    accepted: [
      { type: "replace", word: "gave", to: "let" },
      { type: "insert", word: "permission", after: "student" },
    ],
  ...
  },
  {
    ...
    accepted: [
      { type: "replace", word: "in", to: "on" },
      { type: "replace", word: "got", to: "been" },
    ],
  ...
  },
  {
    ...
    accepted: [
      { type: "replace", word: "friend", to: "friends" },
      { type: "insert", word: "a", before: "friend" },
    ],
  ...
  },
  {
    ...
    paper: 3,
    prompt:
      "The student lacks of confidence, although he has studied very hard in the past two years for HKCEE.",
    accepted: [{ type: "delete", word: "of" }],
  ...
  },
  {
    ...
    paper: 3,
    prompt:
      "On Sundays, have a lot of people like lying on that grassland to enjoy the sunlight.",
    accepted: [
      { type: "replace", word: "have", to: "there are" },
      { type: "insert", word: "there", before: "have" },
    ],
    explanation:
      "Cantonese 有 often becomes 'have' by mistake. English needs 'there are a lot of people'.",
    headword: "have",
  },
  {
    id: "p4-01",
    paper: 4,
    prompt:
      "Because she lives in the New Territories and her office is on Hong Kong Island, every day she wakes up at 6 o'clock a.m.",
    accepted: [
      { type: "delete", word: "a.m." },
      { type: "delete", word: "o'clock" },
    ],
  ...
  },
  {
    ...
    paper: 4,
    prompt:
      "I am opposed to her suggestion of opening the air-conditioner; I think we can simply open the windows and let the wind get in to cool us down.",
    accepted: [
      { type: "replace", word: "opening", to: "turning on" },
      { type: "replace", word: "opening", to: "switching on" },
    ],
  ...
  },
  {
    ...
    paper: 4,
    prompt:
      "Many of parents in Hong Kong try their best to make their children work hard for public examinations.",
    accepted: [{ type: "delete", word: "of" }],
  ...
  },
  {
    ...
    paper: 4,
    prompt:
      "Let me tell you a good news – most customers think that the price of the new product of our company is reasonable!",
    accepted: [
      { type: "replace", word: "a", to: "some" },
      { type: "delete", word: "a" },
    ],
  ...
  },
  {
    ...
    paper: 4,
    prompt:
      "From my point of view, while F.5 students should work hard to prepare their HKCEE, they should also pay attention to their health.",
    accepted: [{ type: "insert", word: "for", after: "prepare" }],
  ...
  },
  {
    ...
    paper: 4,
    prompt:
      "If possible, I think F.5 students should still spare some time participating extra curricular activities.",
    accepted: [
      { type: "insert", word: "in", after: "participating" },
      { type: "replace", word: "participating", to: "for" },
    ],
  ...
  },
  {
    ...
    paper: 4,
    prompt:
      "I will make my father to give up smoking – in fact, most of our family members object to his smoking habit.",
    accepted: [{ type: "delete", word: "to", nth: 0 }],
  ...
  },
  {
    ...
    accepted: [
      { type: "replace", word: "recognizing", to: "making" },
      { type: "replace", word: "recognizing", to: "meeting" },
      { type: "replace", word: "recognising", to: "making" },
    ],
    explanation:
      "'Recognise' is to realise you already know someone. New friends are made or met.",
    headword: "recognise",
  },
  {
    id: "p4-10",
    paper: 4,
    prompt:
      "Nowadays teenagers spend much money to make their own outlook more attractive – for example, my younger brother has just paid a lot for a new hairstyle.",
    accepted: [
      { type: "replace", word: "outlook", to: "appearance" },
      { type: "replace", word: "outlook", to: "looks" },
    ],
  ...
  },
  {
    ...
    paper: 4,
    prompt:
      "Yesterday, I phoned to my friend to ask him to participate in the activity organized by my club.",
    accepted: [{ type: "delete", word: "to", nth: 0 }],
  ...
  },
  {
    ...
    paper: 4,
    prompt:
      "You can hardly pay attention on the traffic if you are listening to music on your MP3 playing!",
    accepted: [
      { type: "replace", word: "on", to: "to", nth: 0 },
      { type: "replace", word: "playing", to: "player" },
    ],
  ...
  },
  {
    ...
    accepted: [{ type: "replace", word: "quite", to: "quiet" }],
  ...
  },
  {
    ...
    paper: 4,
    prompt:
      "That social worker is very kind; last night when he knew that I had no money, he borrowed $500 to me.",
    accepted: [
      { type: "replace", word: "borrowed", to: "lent" },
      { type: "replace", word: "to", to: "from" },
    ],
  ...
  },
  {
    ...
    paper: 4,
    prompt:
      "If you feel hot, just put off your coat! Don't ask me to switch on the air-conditioner!",
    accepted: [{ type: "replace", word: "put", to: "take" }],
  ...
  },
  {
    ...
    accepted: [
      { type: "insert", word: "the", before: "New" },
      { type: "insert", word: "more", before: "than" },
    ],
    explanation:
      "Say 'the New Territories' (plural place names take 'the'). Also, 'like … than' needs 'more'.",
  ...
  },
  {
    ...
    paper: 5,
    prompt:
      "Since that locker does not look safety, I store my valuables in my school bag during PE lessons.",
    accepted: [{ type: "replace", word: "safety", to: "safe" }],
  ...
  },
  {
    ...
    paper: 5,
    prompt:
      "In order to raise the amount of sales of the shop, the sales put up an eye-catching poster at the entrance.",
    accepted: [
      { type: "replace", word: "sales", to: "salespeople", nth: 1 },
      { type: "replace", word: "sales", to: "salespersons", nth: 1 },
      { type: "replace", word: "sales", to: "salesperson", nth: 1 },
    ],
  ...
  },
  {
    ...
    accepted: [{ type: "delete", word: "that" }],
  ...
  },
  {
    ...
    accepted: [
      { type: "replace", word: "succeed", to: "successful" },
      { type: "replace", word: "succeed", to: "successful" },
    ],
  ...
  },
  {
    ...
    accepted: [{ type: "replace", word: "too", to: "either" }],
  ...
  },
  {
    ...
    paper: 5,
    prompt:
      "Every year, quite a number of people in HK suicide due to pressure; I suggest depressed people seek help from social workers.",
    accepted: [
      { type: "insert", word: "commit", before: "suicide" },
      { type: "replace", word: "suicide", to: "commit suicide" },
    ],
  ...
  },
  {
    ...
    accepted: [
      { type: "replace", word: "a.m.", to: "noon" },
      { type: "replace", word: "12:00", to: "noon" },
    ],
  ...
  },
  {
    ...
    paper: 5,
    prompt:
      "Though he likes the film very much, I can sure that he has not bought the DVD of the film, since the DVD is very expensive!",
    accepted: [
      { type: "replace", word: "can", to: "am" },
      { type: "insert", word: "be", after: "can" },
    ],
  ...
  },
  {
    ...
    accepted: [
      { type: "insert", word: "on", after: "sitting" },
      { type: "replace", word: "sitting", to: "taking" },
    ],
  ...
  },
  {
    ...
    accepted: [
      { type: "insert", word: "member", after: "staff" },
      { type: "replace", word: "staff", to: "staff member" },
    ],
  ...
  },
  {
    ...
    accepted: [{ type: "replace", word: "surprise", to: "surprised" }],
  ...
  },
  {
    ...
    accepted: [{ type: "replace", word: "surprise", to: "surprising" }],
  ...
  },
  {
    ...
    accepted: [
      { type: "replace", word: "vocabularies", to: "words" },
      { type: "replace", word: "vocabularies", to: "vocabulary items" },
    ],
  ...
  },
  {
    ...
    accepted: [{ type: "insert", word: "for", after: "waiting" }],
  ...
  },
  {
    ...
    accepted: [
      { type: "replace", word: "so-call", to: "so-called" },
      { type: "replace", word: "so-call", to: "so-called" },
    ],
  ...
  // Drills from the atlas — short single-error sentences
  {
    id: "d-across",
    paper: "drill",
    prompt: "I acrossed the road on my way to school.",
    accepted: [{ type: "replace", word: "acrossed", to: "crossed" }],
  ...
  },
  {
    ...
    accepted: [{ type: "delete", word: "with" }],
  ...
  },
  {
    ...
    accepted: [
      { type: "replace", word: "advices", to: "advice" },
      { type: "replace", word: "are", to: "is" },
    ],
  ...
  },
  {
    ...
    accepted: [{ type: "insert", word: "am", before: "afraid" }],
  ...
  },
  {
    ...
    accepted: [{ type: "insert", word: "for", after: "apply" }],
  ...
  },
  {
    ...
    accepted: [{ type: "replace", word: "to", to: "washing" }],
  ...
  },
  {
    ...
    accepted: [{ type: "replace", word: "before", to: "ago" }],
  ...
  },
  {
    ...
    accepted: [
      { type: "replace", word: "behaviours", to: "behaviour" },
      { type: "replace", word: "are", to: "is" },
    ],
  ...
  },
  {
    ...
    accepted: [{ type: "replace", word: "to", to: "and" }],
  ...
  },
  {
    ...
    accepted: [{ type: "replace", word: "boring", to: "bored" }],
  ...
  },
  {
    ...
    accepted: [{ type: "replace", word: "British", to: "Britain" }],
  ...
  },
  {
    ...
    accepted: [{ type: "replace", word: "broadcasted", to: "broadcast" }],
  ...
  },
  {
    ...
    accepted: [{ type: "replace", word: "brought", to: "bought" }],
  ...
  },
  {
    ...
    accepted: [{ type: "replace", word: "cheap", to: "low" }],
  ...
  },
  {
    ...
    accepted: [{ type: "replace", word: "China", to: "Chinese" }],
  ...
  },
  {
    ...
    accepted: [{ type: "replace", word: "choice", to: "choose" }],
  ...
  },
  {
    ...
    accepted: [{ type: "replace", word: "cloths", to: "clothes" }],
  ...
  },
  {
    ...
    accepted: [{ type: "delete", word: "colour" }],
  ...
  },
  {
    ...
    accepted: [{ type: "replace", word: "comfort", to: "comfortable" }],
  ...
  },
  {
    ...
    accepted: [{ type: "replace", word: "cooker", to: "cook" }],
  ...
  },
  {
    ...
    accepted: [{ type: "replace", word: "everyday", to: "every day" }],
  ...
  },
  {
    ...
    accepted: [{ type: "replace", word: "were", to: "was" }],
  ...
  },
  {
    ...
    accepted: [
      { type: "replace", word: "evidences", to: "evidence" },
      { type: "replace", word: "are", to: "is" },
    ],
  ...
  },
  {
    ...
    accepted: [{ type: "delete", word: "most" }],
  ...
  },
  {
    ...
    accepted: [{ type: "replace", word: "furnitures", to: "furniture" }],
  ...
  },
  {
    ...
    accepted: [{ type: "replace", word: "hardly", to: "hard" }],
  ...
  },
  {
    ...
    accepted: [{ type: "replace", word: "homeworks", to: "homework" }],
  ...
  },
  {
    ...
    accepted: [{ type: "replace", word: "informations", to: "information" }],
  ...
  },
  {
    ...
    accepted: [{ type: "replace", word: "lend", to: "borrowed" }],
  ...
  },
  {
    ...
    accepted: [{ type: "insert", word: "to", after: "listening" }],
  ...
  },
  {
    ...
    accepted: [{ type: "delete", word: "more" }],
  ...
  },
  {
    ...
    accepted: [{ type: "insert", word: "to", after: "objects" }],
  ...
  },
  {
    ...
    accepted: [
      { type: "replace", word: "opened", to: "turned on" },
      { type: "replace", word: "opened", to: "switched on" },
    ],
  ...
  },
  {
    ...
    accepted: [{ type: "replace", word: "rise", to: "raise" }],
  ...
  },
  {
    ...
    accepted: [{ type: "insert", word: "for", after: "waited" }],
  ...
  },
  {
    ...
    accepted: [{ type: "replace", word: "vocabularies", to: "words" }],
  ...
  },
  {
    ...
    accepted: [{ type: "replace", word: "wear", to: "put on" }],
  ...
  },
  {
    ...
    accepted: [{ type: "replace", word: "wish", to: "hope" }],
  ...
  },
  {
    ...
    accepted: [{ type: "replace", word: "ten-years-old", to: "ten-year-old" }],
...
export function questionsForPaper(paper: PaperId): Question[] {
  return questions.filter((q) => q.paper === paper);
}

export function drillQuestions(): Question[] {
  return questions.filter((q) => q.paper === "drill");
}

export function questionsForHeadword(headword: string): Question[] {
  const key = headword.toLowerCase();
  return questions.filter((q) => q.headword.toLowerCase() === key);
}

export function allTrainable(): Question[] {
  return questions;
}
